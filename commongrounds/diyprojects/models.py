...
class Favorite(models.Model):
    ...
    project_status = models.CharField(max_length=50, choices=STATUS_CHOICES, default='Backlog')
...
class ProjectReview(models.Model):
    ...
    def __str__(self):
        return f"Review by {self.reviewer.display_name} on {self.project.title}"
